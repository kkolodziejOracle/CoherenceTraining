...
$JAVAEXEC -server -showversion $JAVA_OPTS -cp "$COHERENCE_HOME/config/:$COHERENCE_HOME/config/CoherenceObjects-1.0-SNAPSHOT.jar:$COHERENCE_HOME/config/RestLibs-1.0-SNAPSHOT.jar:$COHERENCE_HOME/lib/coherence.jar:$COHERENCE_HOME/lib/coherence-rest.jar"  com.tangosol.net.DefaultCacheServer $1
